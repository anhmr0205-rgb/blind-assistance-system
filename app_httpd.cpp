...
#define LED_LEDC_GPIO            1  //configure LED pin
...
void enable_led(bool en) {  // Turn LED On or Off
  ...
  ledcWrite(LED_LEDC_GPIO, CONFIG_LED_MAX_INTENSITY-duty);
...
// Khai báo một kênh PWM bất kỳ (ví dụ kênh 7 để tránh trùng camera)
const int flash_channel = 7; 

ledcSetup(flash_channel, 5000, 8);         // Cấu hình kênh 7: 5000Hz, độ phân giải 8-bit
ledcAttachPin(pin, flash_channel);         // Gắn chân đèn Flash vào kênh 7
ledcWrite(flash_channel, CONFIG_LED_MAX_INTENSITY); // Bật sáng đèn ở mức tối đa
}
